 ...
 * bezeichnen wuerde. Fernen is jedes <code>BusinessObject</code> als 
 ...
 * diese textuelle Notation in JSON (s. http://www.json.org/) kodiert.
 * </p>
 * 
 * @author mmied/thies
 * @version 1.0
...
public abstract class BusinessObject implements Serializable, IsSerializable {
	 ...
	 * koennen Sie nocheinmal in die Definition des Sprachkerns von Java
